...
window.addEventListener('DOMContentLoaded', () => {
    const gutAnyContentSliders = document.querySelectorAll('.wp-block-gutsliders-any-content');
    if (gutAnyContentSliders.length > 0) {
        gutAnyContentSliders.forEach(slider => {
