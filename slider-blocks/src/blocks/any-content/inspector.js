...
const { PanelBody, SelectControl, ToggleControl, TextareaControl, TextControl } = wp.components;
    ...
    return (
        <InspectorControls>
            <HeaderTabs
                settingTabContent={
                    <Fragment>
                        <PanelBody title={__('Slider Layout', 'slider-blocks')} initialOpen={true}>
                            <ButtonsGroupControl
                        ...
                        <PanelBody title={__('Slider Container', 'slider-blocks')} initialOpen={false}>
                            <ResRangeControl
