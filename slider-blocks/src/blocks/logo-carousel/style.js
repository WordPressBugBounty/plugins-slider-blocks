...
const Style = ({ props }) => {
    ...
    const {
        boxDeskStyles: titleDeskMargin,
        boxTabStyles: titleTabMargin,
        boxMobStyles: titleMobMargin
    } = generateResBoxStyles({
    ...
    const deskStyles = `
		${
            slideDeskMargin
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel {
		...
		${
            slideDeskPadding
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel.${navContainerPosition}.${navPosition} {
		...
		${
            slideDeskHeight || photoDeskPadding || photoBorderDeskStyle || photoBradiusDeskStyles || photoBgColor || photoBgGradient
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-container-outer {
                    ...
                    ${photoBgType === 'classic' ? `background-color: ${photoBgColor};` : ''}
                    ${photoBgType === 'gradient' ? `background-image: ${photoBgGradient};` : ''}
				}`
                : ''
        }
		${
		...
		${
            logoMaxWidth
                ? `.${uniqueId} .swiper-container-outer img{
		...
		${
            titleColor || titleBgColor || titleDeskSpacing || titleDeskTypo
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-caption { 
					${titleColor ? `color: ${titleColor};` : ''}
                    ${titleBgColor ? `background-color: ${titleBgColor};` : ''}
					${titleDeskSpacing ? titleDeskSpacing : ''}
                    ${titleDeskMargin ? titleDeskMargin : ''}
        ...
        ${
            showNavigation && (navDeskMargin || navDeskGap)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-nav {
        ...
        ${
            showNavigation && (navColor || navBgColor || navBorderDeskStyle || navBradiusDeskStyles || navDeskHeight || navDeskWidth)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-button-prev, .${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-prev, .${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-button-next, .${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-next {
		...
		${
            showNavigation && (navHoverColor || navHoverBgColor || navBorderHoverColor)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-button-prev:hover, .${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-prev:hover, .${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-button-next:hover, .${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-next:hover {
        ...
        ${
            showNavigation && navIconDeskSize
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-button-prev::after, .${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-prev svg, .${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-button-next::after, .${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-next svg {
        ...
        ${
            showNavigation && navCustomIconDeskSize
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-prev svg, .${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-next svg {
        ...
        ${
            showPagination && pagDeskMargin
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-pagination {
        ...
        ${
            ...
            (pagBorderDeskStyle || pagBradiusDeskStyles || pagDeskHeight || pagDeskWidth || pagColor)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-pagination-bullet {
        ...
        ${
            showPagination && paginationType === 'bullets' && pagBorderHoverColor
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-pagination-bullet:hover {
        ...
        ${
            ...
            (apagBorderDeskStyle || apagBradiusDeskStyles || apagDeskHeight || apagDeskWidth || activePagColor)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-pagination-bullet-active {
        ...
        ${
            showPagination && paginationType === 'bullets' && apagBorderHoverColor
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-pagination-bullet-active:hover {
        ...
        ${
            showPagination && paginationType === 'fraction' && (fracDividerColor || fracDeskSize)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-pagination-fraction {
        ...
        ${
            showPagination && paginationType === 'fraction' && pagFracColor
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-pagination-total {
        ...
        ${
            showPagination && paginationType === 'fraction' && pagFracCurrentColor
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-pagination-current {
                    ${pagFracCurrentColor ? `color: ${pagFracCurrentColor};` : ''}
                }`
                : ''
        }
        ${
            linkedLogos && (overlayColor || overlayOpacity || overlayIconColor)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-overlay {
        ...
        ${
            linkedLogos && (overlayIconColor || iconSize || iconHSize)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-overlay svg{
                    ${overlayIconColor ? `color: ${overlayIconColor};` : ''}
                    ${iconSize ? iconSize : ''}
                    ${iconHSize ? iconHSize : ''}
                }`
        ...
        ${
            linkedLogos && overlayIconHoverColor
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-overlay .overlay-icon:hover svg{
        ...
        ${
            linkedLogos && (overlayIconBgColor || iconContainerHeight || iconContainerWidth)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-overlay .overlay-icon{
        ...
        ${
            linkedLogos && overlayIconHoverBgColor
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-overlay .overlay-icon:hover {
    ...
    const tabStyles = `
        ...
        ${
            logoMaxWidthTab
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-container-outer img{
                    ${logoMaxWidthTab ? logoMaxWidthTab : ''}
				}`
                : ''
        }
		${
        ...
        ${
            showNavigation && navIconTabSize
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-button-prev::after, .${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-button-next::after {
        ...
        ${
            linkedLogos && (iconSizeTab || iconHSizeTab)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-overlay svg{
        ...
        ${
            linkedLogos && (iconContainerHeightTab || iconContainerWidthTab)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-overlay .overlay-icon{
    ...
    const mobStyles = `
        ...
        ${
            logoMaxWidthMob
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-container-outer img{
                    ${logoMaxWidthMob ? logoMaxWidthMob : ''}
				}`
                : ''
        }
		${
            photoBorderHoverColor
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .swiper-container-outer:hover {
        ...
        ${
            linkedLogos && (iconSizeMob || iconHSizeMob)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-overlay svg{
        ...
        ${
            linkedLogos && (iconContainerHeightMob || iconContainerWidthMob)
                ? `.${uniqueId}.wp-block-gutsliders-logo-carousel .gutslider-overlay .overlay-icon{
