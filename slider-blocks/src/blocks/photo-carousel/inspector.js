...
import { PanelBody, TextareaControl, SelectControl, ToggleControl, GradientPicker, TextControl } from '@wordpress/components';
            ...
            <HeaderTabs
                settingTabContent={
                    <Fragment>
                        <PanelBody title={__('General', 'slider-blocks')} initialOpen={true}>
                            ...
                            />
                            <ToggleControl
                                label={__('Enable Hover Overlay', 'slider-blocks')}
                                checked={enableOverlay}
                                onChange={() => setAttributes({ enableOverlay: !enableOverlay })}
                            />
                            <ToggleControl
                                label={__('Enable Lightbox', 'slider-blocks')}
                                checked={enableLightbox}
                                onChange={() => setAttributes({ enableLightbox: !enableLightbox })}
                                help={__('Lightbox works at the frontend only.', 'slider-blocks')}
                            />
                            {enableLightbox && (
                                <ToggleControl
                                    label={__('Take Photos from Single Instance', 'slider-blocks')}
                                    checked={takePhotosFromSingleInstance}
                                    onChange={() => setAttributes({ takePhotosFromSingleInstance: !takePhotosFromSingleInstance })}
                                    help={__('This will take photos from the single instance of this block.', 'slider-blocks')}
                                />
                            )}
                            <ProLock>
                                <ToggleControl
                ...
                designTabContent={
                    <Fragment>
                        ...
                        {enableOverlay && (
                            <PanelBody title={__('Hover Overlay', 'slider-blocks')} initialOpen={false}>
                                <ResRangeControl
