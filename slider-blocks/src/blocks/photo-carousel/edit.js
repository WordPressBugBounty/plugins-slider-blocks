    ...
    if (preview) {
        return (
            <div className="gutslider-preview">
                <img src={gutslider_preview.photo_carousel} alt="carousel" />
            </div>
        );
    }
                    ...
                    <div className="swiper-wrapper">
                        {slideItems && slideItems.length > 0 ? (
                            ...
                            <MediaPlaceholder
                                ...
                                multiple={true}
                                labels={{
                                    title: __('Upload Multiple Photos', 'slider-blocks'),
                                    instructions: __('Upload multiple photos directly or from your media library', 'slider-blocks')
                                }}
                            />
                        )}
                    </div>
