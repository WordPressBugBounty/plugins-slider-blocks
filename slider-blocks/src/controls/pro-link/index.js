...
const ProLink = ({ message = '', link = 'https://gutslider.com/pricing' }) => {
    return (
        <>
            {gutslider_preview?.is_pro === '' && (
                <div className="gkits-pro-link-container">
                    <p className="unlock-feature">{__('Upgrade to Pro to unlock more features.', 'slider-blocks')}</p>
                    <a href={link} target="_blank" rel="noopener noreferrer" className="gkits-pro-link">
                        ...
                        {message ? message : __('Get Pro', 'slider-blocks')}
                    </a>
                </div>
            )}
        </>
